...
Start-Process 'pnputil.exe /add-driver "$Env:TEMP\m478f\hpclC62A4_x64.inf" /install' -Wait
Start-Process 'pnputil.exe /add-driver "$Env:TEMP\mfp4103\hplo03744_x64.inf" /install' -Wait
